...
const Calculation = function () {
    ...
    keyss.forEach(element => {
        ...
        for (let i = 0; i < 7; i++) {
            ...
            //console.log(date7)
            var checkDir1 = fs.existsSync("./value/" + date7 + rate1 + ".json");
            ...
            if (checkDir1) {
                ...
                //讀檔案
                var file_contents = fs.readFileSync("./value/" + date7 + rate1 + ".json", 'utf-8');
...
function check(result1) {
    ...
    result1.forEach(item => {
        ...
        ratesum.id.push(item.Bankname);
        ratesum.date.push(parseFloat(item.Middle_price))
        console.log( ratesum)
